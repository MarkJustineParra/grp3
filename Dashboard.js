...
const Dashboard = ({ setIsLoggedIn, setShowAboutUs }) => {
  ...
  const [showExtendedDescription, setShowExtendedDescription] = useState(false); // New state for description toggle
  ...
  const toggleDescription = () => {
    setShowExtendedDescription((prev) => !prev); // Toggle the description
  };
    ...
    <ScrollView contentContainerStyle={styles.dashboardContainer}>
      <View style={styles.dashboardBox}>
        <View style={styles.photoSliderContainer}>
          ...
          >
            <Image source={require('./assets/image1.png')} style={styles.photoSliderLarge} />
            <Image source={require('./assets/image2.png')} style={styles.photoSliderLarge} />
            <Image source={require('./assets/image3.png')} style={styles.photoSliderLarge} />
          </ScrollView>
      ...
      <Text style={styles.welcomeText}>Welcome to your Physical </Text>
      <Text style={styles.welcomeText}>Education. </Text>
      ...
      {/* "Other" Button Below Description */}
      <TouchableOpacity style={styles.otherButton} onPress={toggleDescription}>
        <Text style={styles.otherButtonText}>See more</Text>
      </TouchableOpacity>

      {/* Extended Description */}
      {showExtendedDescription && (
  <View style={styles.extendedDescriptionContainer}>
    <View style={styles.extendedDescriptionBox}>
    <Text style={styles.extendedDescription}>
      Physical education encompasses a wide range of activities beyond traditional sports. It includes exercises that promote strength, flexibility, endurance, and mental wellness. The aim is not just to improve physical fitness but also to foster lifelong habits of health and well-being. 
    </Text>
    </View>
    <View style={styles.extendedDescriptionBox}>
    <Text style={styles.extendedDescription}>
    ...
    <View style={styles.extendedDescriptionBox}>
    <Text style={styles.extendedDescription}>
    {"\n"}Physical education is a school-based program that encourages students to stay active while developing essential motor skills and fitness.
    </Text>
    </View>
    <View style={styles.extendedDescriptionBox}>
    <Text style={styles.extendedDescription}>
    {"\n"} By embracing a variety of physical activities, individuals can experience holistic growth, improve resilience, and develop a positive mindset toward fitness. Through regular participation, physical education can transform health, cultivate teamwork skills, and boost confidence.
    </Text>
    </View>
    <View style={styles.extendedDescriptionBox}>
    <Text style={styles.extendedDescription}>
...
<Modal
  ...
  extendedDescriptionBox: {
    backgroundColor: '#f0ad4e', // Background color of the box
    borderRadius: 10, // Rounded corners
    padding: 15, // Padding inside the box
    marginVertical: 7, // Space between boxes
    shadowColor: '#000',
    shadowOpacity: 0.1,
    shadowRadius: 5,
